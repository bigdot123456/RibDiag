...
if __name__ == '__main__':
    pass
    # dcm_df = find_all_dcm_info_and_its_id(path='/Users/liqinghua/projects/medical-rib/dataset/dataset_mark')
    # print(dcm_df)
    # location_df = location_read(folder_path='/Users/liqinghua/Desktop/rib_fracture')
