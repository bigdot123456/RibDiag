...
for _id in np.unique(pred_df['file_id']):
    ...
    image_path = '{}/{}.jpg'.format("/Users/liqinghua/projects/medical-rib/data/voc2007.test_unpredict/JPEGImages", _id)
    xml_path = '{}/{}.xml'.format("/Users/liqinghua/projects/medical-rib/data/voc2007.test_unpredict/Annotations", _id)
