...
excel_df = read_excel("/Users/liqinghua/projects/medical-rib/data/csv_files/rib_type_location.xls")
excel_df.drop(columns=['id'], inplace=True)


for idx, row in excel_df.iterrows():
    nii_path = "/Users/liqinghua/projects/medical-rib/data/nii_csv_files/{}.csv".format(row['location_id'])
    ...
    plt.savefig("/Users/liqinghua/Desktop/point_plto/{}.png".format(row['location_id']))
    plt.show(False)
