...
main_path = "/Users/liqinghua/projects/medical-rib"
date_tag = ""
...
#double_ribs = pd.read_csv("/Users/liqinghua/projects/medical-rib/tools/problems_for_labels/share_box_ribs.csv")
#files = double_ribs['id'].unique()
id_df = pd.read_csv("/Users/liqinghua/projects/medical-rib/tools/problems_for_labels/all_id.csv", dtype={'id': np.str})
