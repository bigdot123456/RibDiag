...
image_ids, confidence, BB = read_det("/Users/liqinghua/projects/medical-rib/models/darknet/results/hurt.txt")
for id, p, box in zip(image_ids, confidence, BB):
    groudtruth_path = "/Users/liqinghua/voc2007.xoy/Annotations/{}.xml".format(id)
    image_path = "/Users/liqinghua/voc2007.xoy/JPEGImages/{}.jpg".format(id)
